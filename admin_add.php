<?php
	...
	if(isset($_POST['add'])){
		...
		$query = "INSERT INTO books VALUES ('" . $isbn . "','" . $type . "',  '" . $title . "', '" . $author . "', '" . $image . "', '" . $descr . "', '" . $price . "', '" . $publisherid . "', '" . $categoryid . "')";
		...
		<table class="table">
			...
			<tr>
				...
				<td>
					...
					<select name="type" id="TextBox1" onchange="date_diff_indays()" >
...
document.getElementById("TextBox4").value = from == 'Donating' ? 0 : null;
