<?php
  ...
  $conn = db_connect();
  $query = "SELECT * FROM books join publisher on books.publisherid=publisher.publisherid where type like'%$text%' or  book_isbn like'%$text%' or book_author like '%$text%' or book_title like '%$text%' or publisher_name like  '%$text%' ";
